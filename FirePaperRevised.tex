...
\begin{figure}[htbp]
	\begin{center}
<<<<<<< HEAD
		\includegraphics[width=0.95\linewidth]{../Figures/Fig1a_b_c.png}
=======
		\includegraphics[width=0.95\linewidth]{../Figures/Fig01a_b_c.png}
...
\begin{figure}[htbp]
	\begin{center}
<<<<<<< HEAD
		\includegraphics[width=0.80\linewidth]{../Figures/Fig2a_b.png}
=======
		\includegraphics[width=0.80\linewidth]{../Figures/Fig02a_b.png}
>>>>>>> parent of ba912b5... Changed path to Figures folder
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
<<<<<<< HEAD
		\includegraphics[width=0.95\linewidth]{../Figures/Fig3a.pdf}
=======
		\includegraphics[width=0.95\linewidth]{../Figures/Fig03a.pdf}
>>>>>>> parent of ba912b5... Changed path to Figures folder
		\caption{Steel foam}
		\label{fig3:sub1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
<<<<<<< HEAD
		\includegraphics[width=0.95\linewidth]{../Figures/Fig3b.pdf}
=======
		\includegraphics[width=0.95\linewidth]{../Figures/Fig03b.pdf}
>>>>>>> parent of ba912b5... Changed path to Figures folder
...
\begin{figure}[htbp]
	\begin{center}
<<<<<<< HEAD
		\includegraphics[width=0.75\linewidth]{../Figures/Fig5.png}
=======
		\includegraphics[width=0.75\linewidth]{../Figures/Fig05.png}
>>>>>>> parent of ba912b5... Changed path to Figures folder
...
\begin{figure}[htbp]
	\begin{center}
<<<<<<< HEAD
		\includegraphics[width=0.75\linewidth]{../Figures/Fig7.pdf}
=======
		\includegraphics[width=0.75\linewidth]{../Figures/Fig07.pdf}
>>>>>>> parent of ba912b5... Changed path to Figures folder
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.75\linewidth]
<<<<<<< HEAD
		{../Figures/Fig9-SimulatedCompression}
=======
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.75\linewidth]
		{../Figures/Fig10-Blue_brittleness.pdf}
		\caption{(left) HS steel foam specimen before testing, (right) HS steel foam specimen after testing at $300\,^{\circ}\mathrm{C}$ following 30 minute exposure. Discoloration of the heated specimen indicated formation of the blue oxide film, which was highly likely stiffening the spherical shells. Formation of the stiffer oxide layer could explain better experimental performance of the steel foam samples, in comparison to the simulated predictions.}
		\label{fig:BlueOxide}
	\end{center}
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}{0.50\textwidth}
		\centering
		\includegraphics[width=0.90\linewidth]
		{../Figures/Fig22a-energyEfficiency-Fe.pdf}
		\caption{Steel foam}
	...
	\begin{subfigure}{0.50\textwidth}
		\centering
		\includegraphics[width=0.90\linewidth]
		{../Figures/Fig22b-energyEfficiency-Al.pdf}
		\caption{Aluminum foam}
...
\begin{figure}
	...
	\begin{subfigure}{0.50\textwidth}
		\centering
		\includegraphics[width=0.90\linewidth]
		{../Figures/Fig23a-retentionFactor-Fe.pdf}
		\caption{Steel foam}
	...
	\begin{subfigure}{0.50\textwidth}
		\centering
		\includegraphics[width=0.90\linewidth]
		{../Figures/Fig23b-retentionFactor-Al.pdf}
		\caption{Aluminum foam}
		\label{retention_Al}
	\end{subfigure}

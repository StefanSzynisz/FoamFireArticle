...
\nomenclature{$\sigma_{failure}$}{Failure Stress}
	...
	\nomenclature{$E_{b}(\mathrm{T})$}{Slope of the linear segment passing through $(\sigma_d, \epsilon_d)$ determined through the least-square fit of Richard's equation to experimental data}
